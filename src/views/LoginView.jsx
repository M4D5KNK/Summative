                    ...
                    <div className="log-reg-box">
                        ...
                        <div className="field">
                            ...
                            <input autocCmplete="off" id="logemail" placeholder="Email" className="input-field"
                                name="logemail" type="email" ref={email} required />
                        </div>
                        <div className="field">
                            <svg className="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <input autoComplete="off" id="logpass" placeholder="Password" className="input-field"
                                name="logpass" type="password" value={password} onChange={(event) => { setPassword(event.target.value) }} required />
                        </div>
                        <button className="btn" type="submit">Login</button>
                        <button className="btn" type="submit" onClick={() => loginWithGoogle()}>Login With Google</button>
                        <a className="btn-link"><Link to={`/register`} className="register-link">Register Now</Link></a>
                    </div>
                </div>
            </form>
            <FooterSection />
